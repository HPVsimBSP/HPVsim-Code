...
df_all = pd.read_csv("RandomAllParam.csv")
df_noInter  = pd.read_csv("RandomNoInterventions.csv")
df_noScreen  = pd.read_csv("RandomNoScreen.csv")
df_noVacc  = pd.read_csv("RandomNoVac.csv")
...
plt.title("Cancers per 100,000 Women - Random Network")
