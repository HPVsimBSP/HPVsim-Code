...
df_all = pd.read_csv("CoreGroupAllParam.csv")
df_noInter  = pd.read_csv("CoreGroupNoInter.csv")
df_noScreen  = pd.read_csv("CoreGroupNoScreen.csv")
df_noVacc  = pd.read_csv("CoreGroupNoVacc.csv")
...
plt.title("Cancers per 100,000 Women - Core Group Network")
