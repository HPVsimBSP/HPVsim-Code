...
import pickle
#this will be the main file to run and save the sims
OUTPUT_DIR = r'C:\Users\richa\Documents\HPV sim Project\Code\ControlCode'
ALLRUNS   = 'CoreGroupNoVacc02.csv' #IMPORTANT TO CHANGE EVERYTIME (maybe?)

N_RUNS = 5 #due to multisim stuff I think 5 is max I can run on a 6 core cpu

seeds = [0, 6, 12, 18, 24, 30, 36, 42, 48, 54]
        #10 seeds gets us to 5 * 10 = 50 total runs
